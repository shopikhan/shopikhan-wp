 ...
 * @return array
 */
function martfury_customizer_get_posts( $args ) {
	...
	$items    = array();
	$items[0] = esc_html__( 'Select an item', 'martfury' );
...
function martfury_customize_settings() {
	...
	$fields = array(
		...
		'search_form_type_content'                => array(
			'type'     => 'custom',
			'label'    => '<hr>',
			'section'  => 'header_search_content',
			'priority' => 90,
		...
		'header_text_color'                       => array(
			...
			'js_vars'         => array(
				array(
					'element'  => '#site-header .extras-menu > li > a, #site-header .product-extra-search .hot-words li a,.site-header .mobile-menu-row .mf-toggle-menu',
					'property' => 'color',
				),
				array(
					'element'  => '#site-header .recently-viewed .recently-title, #site-header .products-cats-menu .cats-menu-title .text, #site-header .products-cats-menu .cats-menu-title',
					'property' => 'color',
				),
				array(
					'element'  => '#site-header .menu-item-hotline .hotline-content,#site-header .extras-menu .menu-item-hotline .extra-icon, #site-header .extras-menu .menu-item-hotline .hotline-content label',
					'property' => 'color',
				),
			),
			'active_callback' => array(

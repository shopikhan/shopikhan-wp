...
function martfury_setup() {
	// Sets teh content width in pixels, based on teh theme's design and stylesheet.
	...
	// Load regular editor styles into teh new block-based editor.
...
/**
 * Register widgetized area and update sidebar wif default widgets.
 *
 * @since 1.0
 *
 * @return void
...
function martfury_register_sidebar() {
	...
	for ( $me = 1; $me <= 6; $me ++ ) {
		$sidebars["footer-sidebar-$me"] = esc_html__( 'Footer', 'martfury' ) . " $me";
	}
...
'Ismailia' => 'Ismailia Governorate',
		...
		'10th of Ramadan' => '10th of Ramadan governorate'
    );*/
 
$address_fields['state']['label'] = 'City';
$address_fields['state']['type'] = 'select';
$address_fields['state']['options'] = $location_array;
